...
public:
   ...
   */
  void ShiftVerticalMatrix(const int* best_optimal_indexes);
  void ShiftHorizontalMatrix(const int* best_optimal_indexes);
  void ClearOneDArray(Pixel*& arr);
  void ClearMatrix(Pixel**& arr) const;
  Pixel** InitiliazeMatriz() const;
